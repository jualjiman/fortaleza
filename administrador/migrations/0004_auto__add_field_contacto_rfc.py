...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contacto.rfc'
        db.add_column(u'administrador_contacto', 'rfc',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contacto.rfc'
        db.delete_column(u'administrador_contacto', 'rfc')
    ...
    models = {
        u'administrador.acabado': {
            ...
            'descripcion': ('django.db.models.fields.TextField', [], {'default': "'acabado'", 'blank': 'True'}),
        ...
        u'administrador.contacto': {
            ...
            'rfc': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'telefono': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'})
        },
        u'administrador.madera': {
            'Meta': {'object_name': 'Madera'},
            'activo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'descripcion': ('django.db.models.fields.TextField', [], {'default': "'madera de'", 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'imagen': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
            'titulo': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'votos': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        ...
        u'administrador.mensaje': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 30, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
