...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'administrador_categoria', 'descripcion',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'administrador_categoria', 'descripcion')
    ...
    models = {
        ...
        u'administrador.mensaje': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
